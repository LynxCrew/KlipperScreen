    ...
    def __init__(self, configfile, screen=None):
        ...
        try:
            if self.config_path != self.default_config_path:
                ...
                includes = self.resolve_includes(self.config_path.split, [i[8:] for i in self.defined_config.sections() if i.startswith("include ")])
    ...
    def _create_configurable_options(self, screen):
        ...
        for num in SCREEN_BLANKING_OPTIONS:
            ...
            if hour > 0:
                ...
                name = f'{second} ' + ngettext("second", "seconds", second)
