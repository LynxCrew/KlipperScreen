...
class Panel(ScreenPanel):
    ...
    def create_buttons(self):
        ...
        self.buttons = {
            ...
            'control': self._gtk.Button("settings",
                                        self._screen.env.from_string(
                                            self._config.get_menu_name("__print")
                                        ).render(
                                            self._printer.get_printer_status_data()
                                        ),
                                        "color3"),
