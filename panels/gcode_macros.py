...
class Panel(ScreenPanel):
    def __init__(self, screen, title):
        ...
        self.labels["macros_menu"] = Gtk.Box(
    ...
    def run_gcode_macro(self, widget, macro):
        ...
        self._screen._send_action(
            widget, "printer.gcode.script", {"script": f"{macro}{params}"}
        )

    def change_sort(self, widget):
        self.sort_reverse ^= True
        if self.sort_reverse:
            self.sort_btn.set_image(
                self._gtk.Image("arrow-down", self._gtk.img_scale * self.bts)
            )
        else:
            self.sort_btn.set_image(
                self._gtk.Image("arrow-up", self._gtk.img_scale * self.bts)
            )
        self.sort_btn.show()
